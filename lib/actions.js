...
exports.html = function (path, saveType, done) {
  ...
  if (typeof path === 'function' && !saveType && !done) {
    ...
    saveType = undefined;
    path = undefined;
  } else if ((typeof path === 'undefined' ? 'undefined' : _typeof(path)) === 'object' && typeof saveType === 'function' && !done) {
    done = saveType;
    saveType = path;
    path = undefined;
...
exports.pdf = function (path, options, done) {
  ...
  if (typeof path === 'function' && !options && !done) {
    ...
    options = undefined;
    path = undefined;
  } else if ((typeof path === 'undefined' ? 'undefined' : _typeof(path)) === 'object' && typeof options === 'function' && !done) {
    done = options;
    options = path;
    path = undefined;
