...
var execute = ["(function javascript () {", "  var ipc = __nightmare.ipc;", "  try {", "    var response = ({{!src}})({{!args}})", "    ipc.send('response', response);", "  } catch (e) {", "    ipc.send('error', e.message);", "  }", "})()"].join("\n");
...
var inject = ["(function javascript () {", "  var ipc = __nightmare.ipc;", "  try {", "    var response = (function () { {{!src}} \n})()", "    ipc.send('response', response);", "  } catch (e) {", "    ipc.send('error', e.message);", "  }", "})()"].join("\n");
